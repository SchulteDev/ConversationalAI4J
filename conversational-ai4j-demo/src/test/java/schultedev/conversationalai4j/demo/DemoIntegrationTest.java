 ...
 * Tests the complete web application functionality including Spring Boot server startup,
 * Thymeleaf rendering, and user interaction flows.
 */
...
class DemoIntegrationTest {
    ...
    void testApplicationStartup() {
        ...
        assertEquals(HttpStatus.OK, response.getStatusCode(), 
            "Application should respond with HTTP 200");
    ...
    void testConversationFlow() {
        ...
        ResponseEntity<String> response = restTemplate.postForEntity(
            getBaseUrl() + "/send", formData, String.class);
    ...
    void testEmptyMessageHandling() {
        ...
        String content = response.getBody();
        assertTrue(content.contains("Please enter a message."), 
