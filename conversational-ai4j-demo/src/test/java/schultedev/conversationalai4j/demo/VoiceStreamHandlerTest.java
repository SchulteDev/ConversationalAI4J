...
class VoiceStreamHandlerTest {
    ...
    void handleMessage_FullVoicePipeline_ShouldProcessCorrectly() throws Exception {
        ...
        boolean foundProcessingStatus = sentMessages.stream()
            .anyMatch(msg -> msg.getPayload().contains("processing"));
    ...
    void handleMessage_StopRecordingWithoutAudio_ShouldHandleGracefully() throws Exception {
        ...
        var sentMessages = messageCaptor.getAllValues();
        boolean foundErrorStatus = sentMessages.stream()
            .anyMatch(msg -> msg.getPayload().contains("error") || 
                           msg.getPayload().contains("No audio"));
    ...
    void handleMessage_LargeAudioChunks_ShouldAccumulate() throws Exception {
        ...
        boolean foundCompleteStatus = messages.stream()
            .anyMatch(msg -> msg.getPayload().contains("complete") || 
                           msg.getPayload().contains("ready"));
