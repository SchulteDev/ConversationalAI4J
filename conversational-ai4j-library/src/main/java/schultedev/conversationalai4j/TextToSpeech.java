...
/**
 * Text-to-Speech service using sherpa-onnx for privacy-first local processing. Converts text input
 * to audio without requiring internet connection.
 */
public class TextToSpeech {
  ...
  public TextToSpeech(Path modelPath, String language, String voice) {
    ...
    this.synthesizerHandle =
        SherpaOnnxNative.createTtsSynthesizer(modelPath.toString(), language, voice);
  ...
  /**
   * Cleans up resources used by the text-to-speech service. Should be called when the service is no
   * longer needed.
   */
  public void close() {
