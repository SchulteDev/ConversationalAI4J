 ...
 *
 * <p>This class provides specialized conversation functionality that combines different
 * input/output modalities beyond the core ConversationalAI API.
 */
public class ConversationUtils {
   ...
   *
   * <p>This method provides voice input with text output, useful for scenarios where you want to
   * capture spoken input but display text responses.
   *
   ...
   *
   * <p>This method provides text input with voice output, useful for scenarios where you want to
   * type input but receive spoken responses.
   *
   * @param ai ConversationalAI instance with speech configured
