 ...
 * 
 * This class provides specialized audio processing functionality that goes beyond
 * the core ConversationalAI API. Use these methods when you need fine-grained
 * control over audio formats and processing.
 */
public class AudioUtils {
     ...
     * 
     * This method provides more control over audio format handling compared to
     * the standard ConversationalAI speech processing.
     *
     ...
     * 
     * This method performs speech-to-text conversion without any AI chat processing.
     * Useful for testing speech recognition capabilities or debugging audio issues.
     *
     * @param ai ConversationalAI instance with speech configured
