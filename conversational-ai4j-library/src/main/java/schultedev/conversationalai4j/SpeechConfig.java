...
public class SpeechConfig {
    ...
    /**
     * Creates default English speech configuration with automatic model download.
     * Uses compressed models for optimal size/quality balance.
     * 
    ...
    public static SpeechConfig custom(Path sttModelPath, Path ttsModelPath) {
        return new Builder()
            .withSttModel(sttModelPath)
            .withTtsModel(ttsModelPath)
            .build();
    }
    ...
    public Path getSttModelPath() { return sttModelPath; }
    public Path getTtsModelPath() { return ttsModelPath; }
    ...
    public String toString() {
        return String.format("SpeechConfig{language='%s', voice='%s', enabled=%s}", 
                           language, voice, enabled);
    }
