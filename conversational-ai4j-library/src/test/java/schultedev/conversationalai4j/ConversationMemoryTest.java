...
class ConversationMemoryTest {
  ...
  @Mock private TokenCountEstimator mockTokenizer;
  ...
  void testTokenBasedMemoryWithInvalidTokens() {
    ...
    IllegalArgumentException exception1 =
        assertThrows(
            IllegalArgumentException.class, () -> ConversationMemory.tokenBased(0, mockTokenizer));
    assertEquals("maxTokens must be positive", exception1.getMessage());

    IllegalArgumentException exception2 =
        assertThrows(
            IllegalArgumentException.class, () -> ConversationMemory.tokenBased(-1, mockTokenizer));
  ...
  void testTokenBasedMemoryWithNullTokenizer() {
    ...
    IllegalArgumentException exception =
        assertThrows(
            IllegalArgumentException.class, () -> ConversationMemory.tokenBased(1000, null));
